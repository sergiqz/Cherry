      ...
      <form action="" method="post">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            ...
            <input type="text" class="form-control <?php echo ( isset($error['descripcion']))?"is-invalid":"";?>" required name="descripcion" value="<?php echo $descripcion; ?>" placeholder="" id="txt3" require="">
            <div class="invalid-feedback">
            ...
            <input type="text" class="form-control" required name="estado" value="<?php echo $estado; ?>" placeholder="" id="txt4" require="">
            <br>
            </div>
