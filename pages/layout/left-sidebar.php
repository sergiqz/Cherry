    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li <?php isActive("cliente_tables") ?>>
              <a href="../../pages/tables/cliente_tables.php"><i class="fa fa-circle-o"></i> Clientes </a>
            </li>
          </ul>
          <ul class="treeview-menu">
            <li <?php isActive("contrato_tables") ?>>
              <a href="../../pages/tables/contrato_tables.php"><i class="fa fa-circle-o"></i> Contratos </a>
            </li>
          </ul>
          <ul class="treeview-menu">
            <li <?php isActive("proveedor_tables") ?>>
              <a href="../../pages/tables/proveedor_tables.php"><i class="fa fa-circle-o"></i> Proveedores </a>
            </li>
          </ul>
          <ul class="treeview-menu">
            <li <?php isActive("compra_tables") ?>>
              <a href="../../pages/tables/compra_tables.php"><i class="fa fa-circle-o"></i> Compras </a>
            </li>
          </ul>
          <ul class="treeview-menu">
            <li <?php isActive("categoria_tables") ?>>
              <a href="../../pages/tables/categoria_tables.php"><i class="fa fa-circle-o"></i> Categoria </a>
            </li>
          </ul>
          <ul class="treeview-menu">
            <li <?php isActive("producto_tables") ?>>
              <a href="../../pages/tables/producto_tables.php"><i class="fa fa-circle-o"></i> Producto </a>
            </li>
          </ul>
